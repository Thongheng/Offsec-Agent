...
Informational observations, hardening suggestions, and low-severity noise are **not
submitted** — they burn triage goodwill that your next report spends. Keep them as
notes in `log.jsonl` instead — they seed the next engagement's hunt.
